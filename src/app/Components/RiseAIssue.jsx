          ...
          <div className="gap-3 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
            <div className="flex flex-col drop-shadow-xl items-stretch w-3/12 max-md:w-full max-md:ml-0">
              ...
              >
                ...
                <div className="mt-4">
                  <p>
                    Total Satisfied: {calculateSatisfaction("MESS").satisfied}
                  </p>
                  <p>
                    Total Unsatisfied:{" "}
                    {calculateSatisfaction("MESS").unsatisfied}
                  </p>
                </div>
              </button>
            </div>
            <div className="flex drop-shadow-xl flex-col items-stretch w-3/12 ml-2 max-md:w-full max-md:ml-0">
              ...
              >
                ...
                <div className="mt-4">
                  <p>
                    Total Satisfied:{" "}
                    {calculateSatisfaction("SWEEPER").satisfied}
                  </p>
                  <p>
                    Total Unsatisfied:{" "}
                    {calculateSatisfaction("SWEEPER").unsatisfied}
                  </p>
                </div>
              </button>
            </div>
            <div className="flex drop-shadow-xl flex-col items-stretch w-3/12 ml-2 max-md:w-full max-md:ml-0">
              ...
              >
                ...
                <div className="mt-4">
                  <p>
                    Total Satisfied:{" "}
                    {calculateSatisfaction("LAUNDRY").satisfied}
                  </p>
                  <p>
                    Total Unsatisfied:{" "}
                    {calculateSatisfaction("LAUNDRY").unsatisfied}
                  </p>
                </div>
              </button>
            </div>
            <div className="flex flex-col drop-shadow-xl items-stretch w-3/12 ml-2 max-md:w-full max-md:ml-0">
              ...
              >
                ...
                <div className="mt-4">
                  <p>
                    Total Satisfied:{" "}
                    {calculateSatisfaction("INTERNET").satisfied}
                  </p>
                  <p>
                    Total Unsatisfied:{" "}
                    {calculateSatisfaction("INTERNET").unsatisfied}
                  </p>
                </div>
              </button>
            </div>
